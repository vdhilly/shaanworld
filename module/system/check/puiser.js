...
async function onPuiser(event){
    ...
    let dice
    if(trihn === "necrose"){
       return ui.notifications.warn("Vous ne pouvez pas puiser lors d'un Jet de Nécrose.")
    } else {
...
function getTrihn(domainName){
    let trihn
    const trihns = {esprit:["technique", "savoir", "social"], ame:["arts", "shaan", "magie"], corps:["rituels", "survie", "combat"], necrose: ["necrose"]}
